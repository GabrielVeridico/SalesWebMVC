...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            var department = new Department(1, "Compurtes");
            var department2 = new Department(2, "Eletronics");
            var department3 = new Department(3, "Fashion");
            var department4 = new Department(4, "Books");

            var s1 = new Seller(1, "Bob Junior", "bob@gmail.com", new DateTime(1998, 4, 21), 1000.0, department);
            var s2 = new Seller(2, "Mariana Green", "maria@gmail.com", new DateTime(1979, 5, 12), 1200.0, department2);
            var s3 = new Seller(3, "Alex Grey", "alex@gmail.com", new DateTime(1988, 6, 15), 2400.0, department);
            var s4 = new Seller(4, "Martha Red", "martha@gmail.com", new DateTime(1993, 11, 30), 2200.0, department4);
            var s5 = new Seller(5, "Donald Blue", "donald@gmail.com", new DateTime(2000, 1, 9), 1100.0, department3);
            var s6 = new Seller(6, "Pink Bob Jenkins", "pink@gmail.com", new DateTime(1997, 3, 4), 3000.0, department2);
            ...
            _context.Department.AddRange(department, department2, department3, department4);
